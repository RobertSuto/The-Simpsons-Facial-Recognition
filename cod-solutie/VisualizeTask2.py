...
def show_detections_without_ground_truth(detections, scores, file_names, params: Task2Parameters):
    """
...
def show_detections_with_ground_truth(detections, scores, file_names, params: Task2Parameters):
    """
    ...
    ground_truth_bboxes = np.concatenate((np.loadtxt(params.path_annotations_bart, dtype='str'),
                                          np.loadtxt(params.path_annotations_homer, dtype='str'),
                                          np.loadtxt(params.path_annotations_lisa, dtype='str'),
                                          np.loadtxt(params.path_annotations_marge, dtype='str')))
    test_images_path = os.path.join(params.dir_test_examples, '*.jpg')
    test_files = glob.glob(test_images_path)
